<template>
    <div>
        ...
        <div class="wizard">
            ...
            <div class="bt" :class="{'active': wizard==5 }" @click="wizard = 5" v-b-tooltip.hover :title="$t('spda.sp5')">5</div>
        </div>
        
        <hr>
        <question :section="2" :wizard="wizard" :key="wizard" />
