<template>
    <div>
        <div class="wizard">
            ...
            <div class="bt" :class="{'active': wizard==5 }" @click="wizard = 5; updateQuestions(5)" v-b-tooltip.hover :title="$t('spda.sp4')">5</div>
            <div>
                <svg height="50" width="100">
                    <line x1="0" y1="25" x2="100" y2="25" style="stroke:#007bff;stroke-width:2" />
                </svg>    
            </div>
            <div class="bt" :class="{'active': wizard==6 }" @click="wizard = 6; updateQuestions(6)" v-b-tooltip.hover :title="$t('spda.sp4')">6</div>
            <div>
                <svg height="50" width="100">
                    <line x1="0" y1="25" x2="100" y2="25" style="stroke:#007bff;stroke-width:2" />
                </svg>    
            </div>
            <div class="bt" :class="{'active': wizard==7 }" @click="wizard = 7; updateQuestions(7)" v-b-tooltip.hover :title="$t('spda.sp4')">7</div>
            <div>
                <svg height="50" width="100">
                    <line x1="0" y1="25" x2="100" y2="25" style="stroke:#007bff;stroke-width:2" />
                </svg>    
            </div>
            <div class="bt" :class="{'active': wizard==8 }" @click="wizard = 8; updateQuestions(8)" v-b-tooltip.hover :title="$t('spda.sp4')">8</div>
            <div>
                <svg height="50" width="100">
                    <line x1="0" y1="25" x2="100" y2="25" style="stroke:#007bff;stroke-width:2" />
                </svg>    
            </div>
            <div class="bt" :class="{'active': wizard==9 }" @click="wizard = 9; updateQuestions(9)" v-b-tooltip.hover :title="$t('spda.sp4')">9</div>
        </div>
                ...
                <div class="cols-c" v-if="answers[i] != undefined">
                    ...
                    <div class="col-c" v-if="question['TIPO_2'] != 'NA'">
                        ...
                        <div class="inline2" v-if="question['TIPO_2']== 'año editable'">
                           <span v-if="question['UNIDAD_2'] != 'NA'">{{question['UNIDAD_1']}}</span> <v-select v-model="answers[i]['anio']" :options="yearOpt"></v-select>
                        </div>
                        <br>
                    ...
                    <div class="col-c" v-if="question['TIPO_3'] != 'NA'">
                        ...
                        <div class="inline2" v-if="question['TIPO_3']== 'año editable'">
                           <span v-if="question['UNIDAD_3'] != 'NA'">{{question['UNIDAD_1']}}</span> <v-select v-model="answers[i]['anio']" :options="yearOpt"></v-select>
                        </div>
                        <br>
                    ...
                    <div class="col-c" v-if="question['TIPO_4'] != 'NA'">
                        ...
                        <div class="inline2" v-if="question['TIPO_4']== 'año editable'">
                           <span v-if="question['UNIDAD_4'] != 'NA'">{{question['UNIDAD_1']}}</span> <v-select v-model="answers[i]['anio']" :options="yearOpt"></v-select>
                        </div>
                        <br>
...
export default {
    ...
    async mounted(){
        ...
        try {
            ...
            var val = await window.eel.getSPDAQuestions(this.wizard, 4)(val)
    ...
    methods: {
        ...
        async updateQuestions(wizard){
            ...
            this.$store.dispatch('setLoading')
            try {
                var val = await window.eel.getSPDAQuestions(wizard, 4)(val)
                this.questions = JSON.parse(val)
                for (let i = 0; i < this.questions.length; i++) {
                    setTimeout( async ()=>{ 
                        try{
...
.wizard
    ...
    grid-template-columns: 50px 100px 50px 100px 50px 100px 50px 100px 50px 100px 50px 100px 50px 100px 50px 100px 50px 100px 50px
    div 
        overflow: hidden
        display: grid
        align-items: center
...
<style scoped>
.header-6, .header-7 , .body-6, .body-7{
        display: flex;
        gap: 5px;
        width: 100%;
        background: #007bff;
